...
this, use the <tt>+</tt> operator. This combines multiple action expressions into one, and
assigns the block to all the actions matched by the list of expressions. For example,
